    ...
    let store = crate::profile::default_credential_store();
    {
        ...
        match &cli.command {
            Command::Events { command } => {
                crate::tokyo::commands::events::dispatch(command, &client, &output)?
            }
            Command::Items { command } => {
                crate::tokyo::commands::items::dispatch(command, &client, &output)?
            }
            Command::Auth { .. }
            | Command::Profile { .. }
            | Command::Env { .. }
            ...
            Command::Reset => {
                    ...
                    .rev()
                {
                    ...
                    let handled = match entry.resource.as_str() {
                        "events" => {
                            match crate::tokyo::commands::events::delete_by_id(&id) {
                                Some(variant) => {
                                    let _ = crate::tokyo::commands::events::dispatch(
                                        &variant,
                                        &client,
                                        &output,
                                    );
                        ...
                        "items" => {
                            match crate::tokyo::commands::items::delete_by_id(&id) {
                                Some(variant) => {
                                    let _ = crate::tokyo::commands::items::dispatch(
                                        &variant,
                                        &client,
                                        &output,
                                    );
