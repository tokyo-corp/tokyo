    ...
    let store = crate::profile::default_credential_store();
    {
        ...
        match &cli.command {
            ...
            Command::Users { command } => {
                crate::tokyo::commands::users::dispatch(command, &client, &output)?
            }
            Command::Auth { .. }
            | Command::Profile { .. }
            | Command::Env { .. }
            ...
            Command::Reset => {
                    ...
                    .rev()
                {
                    ...
                    let handled = match entry.resource.as_str() {
                        ...
                        "users" => {
                            match crate::tokyo::commands::users::delete_by_id(&id) {
                                Some(variant) => {
                                    let _ = crate::tokyo::commands::users::dispatch(
                                        &variant,
                                        &client,
                                        &output,
                                    );
